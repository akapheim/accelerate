...
* Fixed a security issue that could allow users to run Javascript on the front-end after a submission in some circumstances. Thanks to Kenan G, @K3n4nG on Twitter, for the responsible disclosure and help tracking down the issue.
